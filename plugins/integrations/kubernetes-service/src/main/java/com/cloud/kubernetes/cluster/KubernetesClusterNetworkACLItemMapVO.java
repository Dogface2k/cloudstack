...
@Entity
@Table(name = "kubernetes_cluster_network_acl_item_map")
public class KubernetesClusterNetworkACLItemMapVO implements InternalIdentity {
    ...
    public KubernetesClusterNetworkACLItemMapVO() {
    }

    public KubernetesClusterNetworkACLItemMapVO(long clusterId, long networkAclItemId, String logicalRole,
