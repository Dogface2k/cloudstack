...
public class KubernetesClusterEventTypes {
    ...
    public static final String EVENT_KUBERNETES_CLUSTER_NETWORK_RULES_RECONCILE = "KUBERNETES.CLUSTER.NETWORK.RULES.RECONCILE";
    public static final String EVENT_KUBERNETES_CLUSTER_NETWORK_RULES_ADOPT = "KUBERNETES.CLUSTER.NETWORK.RULES.ADOPT";
}
