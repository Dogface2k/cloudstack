...
@APICommand(name = "reconcileKubernetesClusterNetworkRules",
        description = "Recreates missing CloudStack-managed network rules for a running CloudManaged Kubernetes cluster without deleting user-managed rules",
...
public class ReconcileKubernetesClusterNetworkRulesCmd extends BaseAsyncCmd {
    ...
    public String getEventType() {
        return KubernetesClusterEventTypes.EVENT_KUBERNETES_CLUSTER_NETWORK_RULES_RECONCILE;
    }

    @Override
    public String getEventDescription() {
        String description = "Reconciling Kubernetes cluster network rules";
    ...
    public void execute() throws ServerApiException, ConcurrentOperationException {
        try {
            if (!kubernetesClusterService.reconcileKubernetesClusterNetworkRules(this)) {
                throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR, "Failed to reconcile Kubernetes cluster network rules");
            }
